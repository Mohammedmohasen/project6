...
<?php $__currentLoopData = $order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="well">  
     <h3><?php echo e($item->name); ?>  <a href="<?php echo e($item->id); ?>" class="btn list-group-item-danger">  <?php echo e($item->phone); ?>     </a>  <?php echo e($item->address); ?>   <?php echo e($item->total); ?>$</h3> 
    </div>
  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?>
<a href="home" class="btn btn-primary">GoBack</a>
